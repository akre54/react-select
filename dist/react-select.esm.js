...
var MultiValueLabelsContainer = MultiValueGeneric;
  ...
  createClass(Select, [{
    ...
    value: function renderPlaceholderOrValue() {
      ...
      var _components = this.components,
          ...
          MultiValueLabelsContainer = _components.MultiValueLabelsContainer,
...
var compareOption = function compareOption(inputValue, option, getOptionLabel$$1, getOptionValue$$1) {
  var candidate = inputValue.toLowerCase();
  return getOptionValue$$1(option).toLowerCase() === candidate || getOptionLabel$$1(option).toLowerCase() === candidate;
};
