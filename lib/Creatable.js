...
var compareOption = function compareOption(inputValue, option, getOptionLabel, getOptionValue) {
  var candidate = inputValue.toLowerCase();
  return getOptionValue(option).toLowerCase() === candidate || getOptionLabel(option).toLowerCase() === candidate;
};
